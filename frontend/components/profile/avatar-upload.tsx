    ...
    <div className={cn("relative", className)}>
      ...
      <div className="relative inline-block">
        ...
        <motion.button
          ...
          className="absolute bottom-0 right-0 size-12 rounded-full bg-accent-blue border-4 border-white shadow-lg flex items-center justify-center touch-manipulation hover:bg-blue-600 transition-colors"
