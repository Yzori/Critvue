...
const getMockChallenge = (id: number): Challenge | null => {
  const mockChallenges: Record<number, Challenge> = {
    ...
    2: {
      ...
      description: "Capture the most dramatic portrait lighting. Show creativity in how you use light and shadow.",
      challengeType: "one_on_one",
    ...
    102: {
      ...
      description: "Capture a stunning landscape photo showcasing natural light and composition.",
      challengeType: "category",
      contentType: "photography",
      status: "open",
      submissionHours: 48,
