...
async def create_test_user(session: AsyncSession, user_config: dict, user_key: str) -> User:
    ...
    user = User(
        ...
        user_tier=user_config.get("user_tier", UserTier.NEWCOMER),
        sparks_points=user_config.get("sparks_points", 0),
