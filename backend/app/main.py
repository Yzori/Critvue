...
from app.api.v1 import reviews, files, browse, profile, portfolio, reviewer_dashboard, expert_applications, subscriptions, notifications, dashboard, dashboard_desktop, platform, admin, gamification, nda, activity, challenges, growth, reviewers, payments, slot_applications, unsubscribe
...
app.include_router(reviews.router, prefix="/api/v1")  # Reviews and review slots
